...
```json
{
  ...
  "check_in_mode": "self_checkin | staff_checkin (optional, default: self_checkin)",
...
```json
{
  ...
  "type": "checkin_prep | checkout_clean | check_in_greeting (required)",
  "items": [
...
```json
{
  "task_id": "uuid",
  "reservation_id": "uuid",
  "type": "checkin_prep | checkout_clean | check_in_greeting",
