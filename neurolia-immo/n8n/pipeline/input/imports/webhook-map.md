...
6. Si `status=confirmed` et `action=created` : appeler WF04 (creation tache) + WF05 (email confirmation guest)
...
| WF01 (Email Parser) | WF05 (Auto Messages) | POST | `/webhook/wf05-auto-message` | Email confirmation guest a envoyer |
...
| Pre-arrival Guest | `0 10 * * *` | Europe/Paris | WF05 | Email pre-arrivee J-1 aux guests |
| Post-departure Guest | `0 14 * * *` | Europe/Paris | WF05 | Email post-depart aux guests |
