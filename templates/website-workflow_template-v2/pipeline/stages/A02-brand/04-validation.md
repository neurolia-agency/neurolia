...
- [ ] **colors.md** : Checks de compatibilité frontend-design2 passés (max 1 accent, saturation < 80%, pas de LILA, pas de #000)
- [ ] **typography.md** : Checks de compatibilité frontend-design2 passés (pas d'Inter, serif contraint, choix justifié)
