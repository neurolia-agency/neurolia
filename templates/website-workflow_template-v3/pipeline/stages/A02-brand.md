...
| **3b. Identité visuelle & Personas** | [03-production-visual.md](A02-brand/03-production-visual.md) | 3 fichiers : personas, colors, typography | `ui-ux-pro-max` (recommande) |
...
**Skill recommande** : `ui-ux-pro-max` (Phase 3b — lookup palettes et font pairings)
