...
## Point de depart : ui-ux-pro-max (recommande)
> Si le client n'a PAS de palette existante, utiliser ui-ux-pro-max.

### Lookup palette
1. Identifier le type de produit depuis `output/00-brief.md`
2. LIRE `.claude/skills/ui-ux-pro-max/data/colors.csv`
3. Trouver les lignes correspondantes (colonne "Product Type")
4. Utiliser comme POINT DE DEPART — personnaliser selon l'archetype
5. Convertir en OKLCH pour l'output final

## Contraintes Qualite Couleurs
> Regles propres au template (independantes de tout skill).
- [ ] Max 1 couleur d'accent
- [ ] Saturation accent < 80%
- [ ] Pas de purple/blue "AI aesthetic" (ban LILA)
- [ ] Pas de neon/outer glows
- [ ] Pas de pure black #000000 — off-black/zinc-950
- [ ] Bases neutres coherentes : Zinc OU Slate
```
...
## Point de depart : ui-ux-pro-max (recommande)
> Si le client n'a PAS de typographie existante, utiliser ui-ux-pro-max.

### Lookup font pairing
1. Identifier les mots-cles d'ambiance depuis `output/01-brand/00-platform.md`
2. LIRE `.claude/skills/ui-ux-pro-max/data/typography.csv`
3. Chercher par "Mood/Style Keywords" et "Best For"
4. Selectionner 2-3 candidats, evaluer contre l'archetype

## Contraintes Qualite Typographie
> Regles propres au template.
- [ ] Police heading ≠ Inter
- [ ] Police heading ≠ police par defaut systeme
- [ ] Si Dashboard/Software UI : Serif BANNI pour heading
- [ ] Pairing evalue contre l'archetype (feeling decrit)
- [ ] Si choix different des pairings ui-ux-pro-max : justifier
```
