...
==================================================================================
              ...
              +------------------+   (Creative Director : dials GLOBAUX)
                       |
        +--------------+--------------+
        v                              v
+------------------+          +------------------+
...
Creative Director (opus-4.6) --> Claude + frontend-design2 --> Technical Validator (haiku)
    [DECIDE layout, tech, dials]   [code le composant]         [verifie regles techniques]
    _preflight/*-creative-dir.md   components/*.tsx             pass/fail + corrections
```

**Custom subagents** : `.claude/agents/` (Phase A : wireframe-validator, token-auditor | Phase B : creative-director, technical-validator, visual-reviewer (opt.), source-reader (opt.))
...
|-------|-------|---------------|--------|---------|-----------|
| **B01** | `B01-layout.md` | `globals.css`, `03-sitemap.md`, art-direction/ | Creative Director + Technical Validator | `components/layout/`, `_preflight/` | A06 |
| **B02** | `B02-homepage.md` | `03.5-wireframes/homepage.md`, art-direction/ | Creative Director + Technical Validator | `components/sections/`, `app/page.tsx`, `_preflight/homepage/` | B01 |
| **B03** | `B03-pages.md` | `03.5-wireframes/*.md`, art-direction/ | Creative Director + Technical Validator | `app/[pages]/`, `_preflight/[pages]/` | B01 |
