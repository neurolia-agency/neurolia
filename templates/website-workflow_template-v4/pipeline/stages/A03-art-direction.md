...
- [ ] Chaque section homepage a : emotion primaire + secondaire + tension + element signature
- [ ] Chaque page secondaire a : emotion globale + parcours emotionnel + element signature
- [ ] Tableau recapitulatif (section / emotion / couleur / element)
- [ ] Courbe emotionnelle du parcours avec objectif narratif
- [ ] PAS de techniques frontend-design2 dans l'emotion-map (decide en Phase B par le Creative Director)

#### Project Dials (project-dials.md)

- [ ] 3 dials globaux definis avec justification (archetype + ambition + complexite technique)
- [ ] Creative Palette : 10-15 techniques compatibles avec la marque (sans assignation a des sections)
- [ ] Techniques exclues listees avec justification
- [ ] Anti-patterns frontend-design2 renforces : 5+ regles critiques identifiees
- [ ] Chaque dial est tracable a un composant brand/brief (pas de valeur arbitraire)
- [ ] Mapping emotion -> dials complete avec les emotions specifiques du projet
