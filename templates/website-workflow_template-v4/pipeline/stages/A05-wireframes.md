...
Creer un **creative brief** pour chaque page, servant de source de contenu et d'intention emotionnelle pour la Phase B. Le frontend-design2 s'appuie sur ces briefs pour DECIDER l'approche visuelle — le brief ne prescrit pas le HOW.

**Principe cle v4** : Les briefs definissent QUOI montrer et QUELLE emotion viser. Le COMMENT (layout, techniques, animations) est decide par le frontend-design2 en Phase B.
...
Chaque page contient des sections. Chaque section suit ce format allege qui laisse l'espace creatif au frontend-design2.
...
### Ce qui N'EST PLUS dans le brief (decide en Phase B par le frontend-design2)

| Ancien champ v3 | Maintenant decide par |
|------------------|----------------------|
| Layout ("Split screen 40/60") | frontend-design2 (Phase B, etape 1) |
| Fond (`visual-vocabulary.md > couleurs > fond principal`) | frontend-design2 |
| Interaction (hover/scroll/click) | frontend-design2 |
| Dials override (VARIANCE: 6, MOTION: 7) | frontend-design2 |
| Technique ("Sticky Scroll Stack, P0") | frontend-design2 |
...
Le frontend-design2 decide COMMENT en Phase B (layout, technique, dials par section).
...
|-------|------|-------------------|
| B1-Layout | 03-sitemap.md | frontend-design2 |
| B2-Homepage | homepage.md | frontend-design2 (par section) |
| B3-Pages | Le brief de chaque page | frontend-design2 (par section) |
```
...
**Produit pour** : A6 (Design Tokens), B1-B3 (Frontend — via frontend-design2)
